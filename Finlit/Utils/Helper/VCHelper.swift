...
class VCHelper :NSObject{
    func addShadowAndBoderUIView(view :UIView) -> UIView {
        ...
        view.layer.shadowOpacity = 1.05
        view.layer.shadowRadius = 2.09
...
//        self.mSearchView.layer.cornerRadius = 5
//        self.mSearchView.layer.borderWidth = 0.3
//        self.mSearchView.layer.borderColor = UIColor.lightGray.cgColor
//        self.mSearchView.clipsToBounds = true
//        mSearchView.layer.masksToBounds = false
        return view
    }
    ...
    func roundtheButtonWithGreenColor(buttonname:UIButton!) -> UIButton
    {
        var green =  UIColor(red:0.41, green:0.70, blue:0.26, alpha:1.0)
        buttonname.layer.borderColor = green.cgColor
