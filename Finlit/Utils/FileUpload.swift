...
class FileUpload {
  ...
  fileprivate let imageUrl = "users/upload/image"
...
//    }
//    cld.createUploader().upload(data: data, uploadPreset: remoteConfig.cloudPreset, progress: progressHandler) { (result, error) in
...
//
  ...
  func uploadImageaaaRemote (image:UIImage, callback:@escaping (_ data: String?, _ error: NSError? ) -> Void){
